...
//    this->displayExplosion();
    ...
    GLfloat v_explosion[] = {
        //bottom
        -0.8f, 0.7f, -0.05f,  0.0f, 0.0f, //0
        -0.7f, 0.7f, -0.05f,  1.0f, 0.0f, //1
        -0.8, 0.8f, -0.05f,  0.0f, 1.0f,  //2
        -0.8, 0.8f, -0.05f,  0.0f, 1.0f,  //2
        -0.7, 0.8f, -0.05f,  1.0f, 1.0f,  //3
        -0.7f, 0.7f, -0.05f, 1.0f, 0.0f, //1
        
        //top
        -0.8f, 0.7f, 0.05f,  0.0f, 0.0f, //4
        -0.7f, 0.7f, 0.05f,  1.0f, 0.0f, //5
        -0.8, 0.8f, 0.05f,  0.0f, 1.0f,  //6
        -0.8, 0.8f, 0.05f,  0.0f, 1.0f,  //6
        -0.7, 0.8f, 0.05f,  1.0f, 1.0f,  //7
        -0.7f, 0.7f, 0.05f,  1.0f, 0.0f, //5
