...
GLfloat Enemy::get_x(void)
{
	return this->x;
}

GLfloat Enemy::get_y(void)
{
	return this->y;
}


void Enemy::set_x(GLfloat x)
{
	this->x = x;
}

void Enemy::set_y(GLfloat y)
{
	this->y = y;
}
